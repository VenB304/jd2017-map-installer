...
if sys.version_info < (3, 12):
    raise SystemExit("JD2017 Map Installer requires Python 3.12 or newer.")

from PyQt6.QtGui import QIcon
from PyQt6.QtWidgets import QApplication

from jd2017_installer.core.config import AppConfig
from jd2017_installer.core.logging_config import apply_log_detail
from jd2017_installer.core.theme import load_theme_stylesheet


def setup_logging(log_detail_level: str = "user") -> None:
    """Configure root logger for the application."""
    root = logging.getLogger("jd2017")
    if root.handlers:
...
def main() -> int:
    ...
    app.setApplicationName("JD2017 Map Installer")
    ...
    from jd2017_installer.ui.main_window import MainWindow
    logger = logging.getLogger("jd2017")
    logger.info("Initializing MainWindow...")
    window = MainWindow()
    window.show()

    logger.info("JD2017 Map Installer v1.0.0 started")
    logger.info("Project root: %s", project_root)
    logger.info("Game directory: %s", startup_config.game_directory)
