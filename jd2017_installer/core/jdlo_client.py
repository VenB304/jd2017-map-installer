...
logger = logging.getLogger("jd2017.core.jdlo_client")
...
def _get_dynamic_user_agent(username: str = None) -> str:
    ...
    base = f"JD2017MapInstaller/{commit_hash} ({os_info}) (+https://github.com/VenB304/jd2017-map-installer; ventralberry@gmail.com)"
    if username:
