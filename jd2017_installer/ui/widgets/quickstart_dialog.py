...
class QuickstartDialog(QDialog):
    ...
    MODES_GUIDE_URL = "https://github.com/VenB304/jd2017-map-installer/blob/master/docs/01_getting_started/MODES_GUIDE.md"

    def __init__(self, parent=None) -> None:
        super().__init__(parent)
        self.setWindowTitle("JD2017 Map Installer - Quickstart Guide")
    ...
    def _build_ui(self) -> None:
        ...
        title = QLabel("Welcome to JD2017 Map Installer V2!")
        ...
        guide.setHtml("""
            ...
            <ol>
                <li><b>Set Game Directory:</b> Go to the 'Configuration' tab and select your JD2017 'data' folder.</li>
                <li><b>Choose Mode:</b>
                    <ul>
            ...
            <p>
                ...
                Open the <a href="https://github.com/VenB304/jd2017-map-installer/blob/main/docs/01_getting_started/MODES_GUIDE.md">Modes Guide</a>.
            </p>
            <p>For more help, visit the <a href="https://github.com/VenB304/jd2017-map-installer">GitHub Repository</a>.</p>
        """)
