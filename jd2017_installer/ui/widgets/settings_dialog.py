...
from jd2017_installer.core.clean_data import clean_game_data
from jd2017_installer.core.localization_update import (
    update_localization,
)
from jd2017_installer.core.songdb_update import (
...
logger = logging.getLogger("jd2017.ui.widgets.settings_dialog")
    ...
    def _on_update_localization(self) -> None:
        if not self._config.game_directory:
            QMessageBox.warning(
                ...
                "Set your JD2017 game directory first, then try localization update again.",
            )
            return
    ...
    def _on_clean_game_data(self) -> None:
        if not self._config.game_directory:
            QMessageBox.warning(
                self,
                "Game Directory Required",
                "Set your JD2017 game directory first, then run Clean Game Data.",
            )
            return
