...
from jd2017_installer.core.config import QUALITY_ORDER

logger = logging.getLogger("jd2017.ui.widgets.config_panel")
...
class ConfigWidget(QWidget):
    ...
    def _build_ui(self) -> None:
        ...
        self._browse_btn.setToolTip("Browse to the JD2017 folder that contains data and engine.")
