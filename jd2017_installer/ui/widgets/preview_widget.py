...
logger = logging.getLogger("jd2017.ui.widgets.preview")
...
class PreviewWidget(QWidget):
    ...
    def _resolve_preview_audio_path(self, audio_path: str) -> str:
        ...
        if path.suffix.lower() in {".ogg", ".opus"}:
            try:
                ...
                cache_dir = Path(tempfile.gettempdir()) / "jd2017_preview_audio_cache"
    ...
    def _resolve_preview_video_path(self, video_path: str) -> str:
        ...
        cache_dir = Path(tempfile.gettempdir()) / "jd2017_preview_cache"
        cache_dir.mkdir(parents=True, exist_ok=True)
