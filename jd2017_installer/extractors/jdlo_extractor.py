...
class JDLOExtractor(BaseExtractor):
    ...
    def extract(self, output_dir: Path) -> Path:
        ...
        from jd2017_installer.core.config import QUALITY_ORDER, QUALITY_PATTERNS
