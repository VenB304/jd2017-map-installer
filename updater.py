...
This module is intentionally **decoupled** from the jd2017_installer package.
...
GITHUB_REPO = "jd2017-map-installer"
...
logger = logging.getLogger("jd2017.updater")
...
class Updater:
    ...
    def _update_via_zip(self, branch: str, old_commit: str) -> UpdateResult:
        ...
        try:
            tmp_dir = tempfile.mkdtemp(prefix="jd2017_update_")
    ...
    def _merge_zip_contents(
        ...
        *,
        ...
        backup_dir = Path(tempfile.mkdtemp(prefix="jd2017_update_backup_"))
